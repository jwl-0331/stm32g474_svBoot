...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
#define APPLICATION_ADDRESS     (uint32_t)0x8006000
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin : PC13_B1_SW_Pin */
  GPIO_InitStruct.Pin = PC13_B1_SW_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(PC13_B1_SW_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : PA5_LD2_LED_Pin */
  GPIO_InitStruct.Pin = PA5_LD2_LED_Pin;
